...
type ContainerAPIClient interface {
	...
	ContainerCommit(ctx context.Context, container string, options containertypes.CommitOptions) (types.IDResponse, error)
	...
	ContainerList(ctx context.Context, options containertypes.ContainerListOptions) ([]types.Container, error)
	...
	ContainerResize(ctx context.Context, container string, options containertypes.ResizeOptions) error
...
type ImageAPIClient interface {
	...
	ImageImport(ctx context.Context, source types.ImageImportSource, ref string, options imageImportOptions) (io.ReadCloser, error)
...
type ServiceAPIClient interface {
	...
	TaskLogs(ctx context.Context, taskID string, options containertypes.LogsOptions) (io.ReadCloser, error)
